...
def generate_tab_files(filepath, tab_file_path, HEATMODULE=True, hydrogen=False, GREEN_HYDROGEN=False, RENEWABLE_GRID_RULE=False):
    ...
    read_file(filepath, 'Generator.xlsx', 'GeneratorInv', [0, 1, 2, 3], tab_file_path = tab_file_path)
    read_file(filepath, 'Generator.xlsx', 'RESGeneratorInv', [0, 1, 2, 3], tab_file_path = tab_file_path)
    ...
    read_file(filepath, 'Transmission.xlsx', 'TransmissionInv', [0, 1, 2, 3], tab_file_path = tab_file_path)
    ...
    read_file(filepath, 'Node.xlsx', 'HydrogenAnnualDemand', [0, 1, 2], tab_file_path = tab_file_path)
    ...
    read_file(filepath, 'Storage.xlsx', 'StoragePWInv', [0, 1, 2, 3], tab_file_path = tab_file_path)
    read_file(filepath, 'Storage.xlsx', 'StorageENInv', [0, 1, 2, 3], tab_file_path = tab_file_path)
    ...
    read_file(filepath, 'NaturalGas.xlsx','PeriodCost', [0,1],tab_file_path = tab_file_path)
    ...
    #read_file(filepath, 'CO2.xlsx', 'CO2_Prices', [0,1], tab_file_path = tab_file_path)
    ...
    if hydrogen is True:
        ...
        read_file(filepath, 'Hydrogen.xlsx', 'ReformerFuelCost', [0,1,2], tab_file_path = tab_file_path)
        ...
        # read_file(filepath, 'Hydrogen.xlsx', 'HydrogenDemand', [0,1,2], tab_file_path = tab_file_path)

        read_file(filepath, 'Hydrogen.xlsx', 'ElyzerInv', [0,1,2], tab_file_path = tab_file_path)
        read_file(filepath, 'Hydrogen.xlsx', 'PipelineInv', [0,1,2,3], tab_file_path = tab_file_path)
        read_file(filepath, 'Hydrogen.xlsx', 'StorageInv', [0,1,2], tab_file_path = tab_file_path)
        read_file(filepath, 'Hydrogen.xlsx', 'ElyzerInv', [0,1,2], tab_file_path = tab_file_path)
        read_file(filepath, 'Hydrogen.xlsx', 'ReformerInv', [0,1,2,3], tab_file_path = tab_file_path)
        ...
        # read_file(filepath, 'Industry.xlsx', 'SteelInv', [0,1,2,3], tab_file_path = tab_file_path)
        # read_file(filepath, 'Industry.xlsx', 'CementInv', [0,1,2,3], tab_file_path = tab_file_path)
        # read_file(filepath, 'Industry.xlsx', 'AmmoniaInv', [0,1,2,3], tab_file_path = tab_file_path)
